...
public class LauncherModel {
    ...
    private static final DashboardNumber m_efficiencyLossMultiplierClose = new DashboardNumber("LauncherModel/Efficiency Loss Multiplier Close", kEfficiencyLossMultiplierClose, true, (newValue) -> {});
    private static final DashboardNumber m_efficiencyLossMultiplierFar = new DashboardNumber("LauncherModel/Efficiency Loss Multiplier Far", kEfficiencyLossMultiplierFar, true, (newValue) -> {});
    private static final DashboardNumber m_closeDistance = new DashboardNumber("LauncherModel/Close Distance", kCloseDistance, false, (newValue) -> {});
    private static final DashboardNumber m_farDistance = new DashboardNumber("LauncherModel/Far Distance", kFarDistance, false, (newValue) -> {});
